        ...
        <div className="bg-neutral-50 dark:bg-slate-900 p-5">
          ...
          <div className="flex space-x-3 mt-5">
            ...
            <Link
              ...
              className="relative h-auto inline-flex items-center justify-center rounded-md transition-colors text-sm sm:text-base font-medium py-2 px-3 bg-[#c5b4ea] hover:bg-[#8b82b7] border border-[#c5b4ea] flex-1 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-6000 dark:focus:ring-offset-0 "
            >
              Checkout
            </Link>
          </div>
